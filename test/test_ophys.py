...
def test_show_grayscale_volume():
    ...
    assert isinstance(VolumeVisualization(vol, default_neurodata_vis_spec), widgets.Widget)
...
class CalciumImagingTestCase(unittest.TestCase):
    ...
    def test_show_two_photon_series(self):
        wid = TwoPhotonSeriesVisualization(self.image_series, default_neurodata_vis_spec)
    ...
    def test_show_3d_two_photon_series(self):
        ...
        wid = TwoPhotonSeriesVisualization(image_series3, default_neurodata_vis_spec)
        assert isinstance(wid, widgets.Widget)
        wid.controls["slider"].value = 50
